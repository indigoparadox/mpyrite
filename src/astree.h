...
#define ASTREE_NODE_TYPE_SEQ_TERM      13
...
#define ASTREE_VALUE_TYPE_LT        7
#define ASTREE_VALUE_TYPE_SUBTRACT  8
#define ASTREE_VALUE_TYPE_MULTIPLY  9
#define ASTREE_VALUE_TYPE_DIVIDE    10
#define ASTREE_VALUE_TYPE_MODULO    11
